...
<html>
    ...
    <div>
        ...
        <form action = "index.php" method = "POST">
                ...
                <input type = "radio" id = "item1" name = "choices" value = "1" />
                <input name = "name1" value = <?php echo "$username[0] "?> >
                <br/> 
                <input type = "radio" id = "item2" name = "choices" value = "2" />
                <input name = "name2" value = <?php echo "$username[1] "?>>
                <br/>
                <input type = "radio" id = "item3" name = "choices" value = "3"/>
                <input name = "name3" value = <?php echo "$username[2] "?>>
                <br/>
                <input type = "radio" id = "item4" name = "choices" value = "4"/>
                <input name = "name4" value = <?php echo "$username[3] "?>>
                <br/>
                <input type = "radio" id = "item5" name = "choices" value = "5"/>
